...
import './Grandmother-grandchild.css';
import { Navigation } from 'lucide-react';

const GrandMotherChildService = () => {
    ...
    return (
        <div className="grandmother-child-service-page">
            <Header />

            {/* Hero Section */}
            <section className="service-hero">
                <div className="hero-background-container">
                    <img src="https://herviewfromhome.com/wp-content/uploads/2024/10/shutterstock_1926117458.jpg" className="hero-background" alt="Hero Background" />
                </div>
                <div className="container">
                    <div className="hero-content">
                        <div className="hero-text">
                            <h1>Xét nghiệm ADN bà cháu</h1>
                            <p className="hero-subtitle">
                                Xác minh quan hệ huyết thống bà cháu với độ chính xác 99,99%.
                        ...
                        <div className="hero-image">
                            <img
                                src="https://herviewfromhome.com/wp-content/uploads/2024/10/shutterstock_1926117458.jpg"
                                alt="Grandmother and Grandchild DNA Testing"
                            />
                        </div>
                    </div>
                </div>
            ...
            {/* Content Sections */}
            <section className="grandmotherchild-service-content">
                <div className="container">

                    {/* Overview Tab */}
                    {activeTab === 'overview' && (
                        <div className="content-tab">
                            <h2>1. Xét nghiệm ADN huyết thống bà cháu bao nhiều tiền?</h2>

                            <p>
                                Xét nghiệm ADN xác định mối quan hệ huyết thống bà cháu được thực hiện với
                                hai mục đích chính: dân sự và hành chính với mức giá khác nhau.
                            </p>

                            <div className="pricing-section">
                                <h3>Chi phí xét nghiệm ADN huyết thống ông cháu, bà cháu dành cho dân sự:</h3>
                                ...
                                <div className="pricing-preview">
                                    <div className="pricing-preview-table">
                                        ...
                                        <div className="pricing-row">
                                            ...
                                            <div className="pricing-cell">4.000.000</div>
                                            <div className="pricing-cell extra-sample-cell">2.000.000</div>
                                        </div>
                                        <div className="pricing-row">
                                            <div className="pricing-cell">Làm Nhanh</div>
                                            <div className="pricing-cell">06 – 24 Tiếng</div>
                                            <div className="pricing-cell">6.500.000</div>
                                            <div className="pricing-cell extra-sample-cell">3.250.000</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="pricing-section">
                                <h3>Chi phí xét nghiệm ADN huyết thống ông cháu, bà cháu dành cho hành chính:</h3>
                                ...
                                <div className="pricing-preview">
                                    <div className="pricing-preview-table">
                                        ...
                                        <div className="pricing-row">
                                            <div className="pricing-cell">Làm Nhanh</div>
                                            <div className="pricing-cell">06 – 24 Tiếng</div>
                                            <div className="pricing-cell">7.500.000</div>
                                            <div className="pricing-cell extra-sample-cell">3.750.000</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="overview-description">
                                <h3>Chi phí xét nghiệm ADN bà cháu tại DNA CHAIN bao gồm:</h3>
                                <ul>
                                ...
                                <div className="note-box">
                                    <h4>Lưu ý về chi phí ADN bà cháu tại một số đơn vị khác:</h4>
                                    <p>
                    ...
                    {activeTab === 'types' && (
                        <div className="content-tab">
                            ...
                            <div className="process-section">
                                <h3>2. Quy trình xét nghiệm ADN bà cháu</h3>
                                ...
                                <div className="accuracy-info">
                                    <div className="accuracy-card">
                                        ...
                                        <p>Công nghệ xét nghiệm ADN hiện đại với độ chính xác lên đến <strong>99,999%</strong> trong việc xác định mối quan hệ huyết thống bà cháu.</p>
                                    </div>
                                </div>
                    ...
                    {activeTab === 'faq' && (
                        <div className="content-tab">
                            <div className="faq-section">
                                <h3>5. Câu hỏi thường gặp về xét nghiệm ADN bà cháu</h3>
                                        ...
                                        <div className="faq-list">
                                            <div className="faq-item">
                                                <h5>
                                                    ...
                                                    Xét nghiệm ADN bà cháu có chính xác không?
                                                </h5>
                                                <p>
                                                    Xét nghiệm ADN bà cháu tại DNA CHAIN có độ chính xác <strong>99.99%</strong> 
                                            ...
                                            <div className="faq-item">
                                                <h5>
                                                    <span className="faq-icon">💰</span>
                                                    Chi phí xét nghiệm ADN bà cháu bao nhiều?
                                                </h5>
                                                <p>
                                                    <strong>ADN Dân sự:</strong><br/>
                                                    • Gói tiêu chuẩn: 4.000.000 VNĐ<br/>
                                                    • Gói làm nhanh: 6.500.000 VNĐ<br/><br/>
                                                    <strong>ADN Hành chính:</strong><br/>
                                                    • Gói tiêu chuẩn: 5.000.000 VNĐ<br/>
                                                    • Gói làm nhanh: 7.500.000 VNĐ
                                                </p>
                                    ...
                                    <div className="faq-category">
                                        ...
                                        <div className="faq-list">
                                            <div className="faq-item">
                                                ...
                                                <p>
                                                    <strong>Có</strong>, cuống rốn là một trong những mẫu tốt nhất cho xét nghiệm ADN bà cháu. 
...
export default GrandMotherChildService;