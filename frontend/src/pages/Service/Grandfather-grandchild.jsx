...
import './Grandfather-grandchild.css';
import { Navigation } from 'lucide-react';

const GrandFatherChildService = () => {
    ...
    return (
        <div className="grandfather-child-service-page">
            <Header />
                ...
                <div className="container">
                    <div className="hero-content">
                        <div className="hero-text">
                            <h1>Xét nghiệm ADN ông cháu</h1>
                            <p className="hero-subtitle">
                                Xác minh quan hệ huyết thống ông cháu với độ chính xác 99,99%.
            ...
            {/* Content Sections */}
            <section className="grandfatherchild-service-content">
                <div className="container">

                    {/* Overview Tab */}
                    {activeTab === 'overview' && (
                        <div className="content-tab">
                            <h2>1. Xét nghiệm ADN huyết thống ông cháu bao nhiều tiền?</h2>

                            <p>
                                Xét nghiệm ADN xác định mối quan hệ huyết thống ông cháu được thực hiện với
                            ...
                            <div className="pricing-section">
                                <h3>Chi phí xét nghiệm ADN huyết thống ông , bà cháu dành cho hành chính:</h3>
                            ...
                            <div className="overview-description">
                                <h3>Chi phí xét nghiệm ADN ông cháu tại DNA CHAIN bao gồm:</h3>
                                <ul>
                                ...
                                <div className="note-box">
                                    <h4>Lưu ý về chi phí ADN ông cháu tại một số đơn vị khác:</h4>
                                    <p>
                    ...
                    {activeTab === 'types' && (
                        <div className="content-tab">
                            ...
                            <div className="process-section">
                                <h3>2. Quy trình xét nghiệm ADN ông cháu</h3>
                                ...
                                <div className="accuracy-info">
                                    <div className="accuracy-card">
                                        ...
                                        <p>Công nghệ xét nghiệm ADN hiện đại với độ chính xác lên đến <strong>99,999%</strong> trong việc xác định mối quan hệ huyết thống ông cháu.</p>
                                    </div>
                                </div>
                    ...
                    {activeTab === 'faq' && (
                        <div className="content-tab">
                            <div className="faq-section">
                                <h3>5. Câu hỏi thường gặp về xét nghiệm ADN ông cháu</h3>
                                        ...
                                        <div className="faq-list">
                                            <div className="faq-item">
                                                <h5>
                                                    ...
                                                    Xét nghiệm ADN ông cháu có chính xác không?
                                                </h5>
                                                <p>
                                                    Xét nghiệm ADN ông cháu tại DNA CHAIN có độ chính xác <strong>99.99%</strong> 
                                            ...
                                            <div className="faq-item">
                                                <h5>
                                                    <span className="faq-icon">💰</span>
                                                    Chi phí xét nghiệm ADN ông cháu bao nhiều?
                                                </h5>
                                                <p>
                                    ...
                                    <div className="faq-category">
                                        ...
                                        <div className="faq-list">
                                            <div className="faq-item">
                                                ...
                                                <p>
                                                    <strong>Có</strong>, cuống rốn là một trong những mẫu tốt nhất cho xét nghiệm ADN ông cháu. 
...
export default GrandFatherChildService;