...
import './Mother-child.css';
import { Navigation } from 'lucide-react';

const MotherChildService = () => {
    ...
    return (
        <div className="mother-child-service-page">
            <Header />
                ...
                <div className="container">
                    <div className="hero-content">
                        <div className="hero-text">
                            <h1>Xét nghiệm ADN mẹ con</h1>
                            <p className="hero-subtitle">
                                Xác minh quan hệ huyết thống mẹ - con với độ chính xác 99,99%.
                        ...
                        <div className="hero-image">
                            <img
                                ...
                                alt="Mother and Child DNA Testing"
                            />
                        </div>
                    </div>
                </div>
            ...
            {/* Content Sections */}
            <section className="motherchild-service-content">
                <div className="container">

                    {/* Overview Tab */}
                    {activeTab === 'overview' && (
                        <div className="content-tab">
                            <h2>1. Xét nghiệm ADN huyết thống mẹ con bao nhiều tiền?</h2>

                            <p>
                                Xét nghiệm ADN xác định mối quan hệ huyết thống mẹ con được thực hiện với
                            ...
                            <div className="overview-description">
                                <h3>Chi phí xét nghiệm ADN mẹ con tại DNA CHAIN bao gồm:</h3>
                                <ul>
                                ...
                                <div className="note-box">
                                    <h4>Lưu ý về chi phí ADN mẹ con tại một số đơn vị khác:</h4>
                                    <p>
                    ...
                    {activeTab === 'types' && (
                        <div className="content-tab">
                            ...
                            <div className="process-section">
                                <h3>2. Quy trình xét nghiệm ADN mẹ con</h3>
                                ...
                                <div className="accuracy-info">
                                    <div className="accuracy-card">
                                        ...
                                        <p>Công nghệ xét nghiệm ADN hiện đại với độ chính xác lên đến <strong>99,999%</strong> trong việc xác định mối quan hệ huyết thống mẹ con.</p>
                                    </div>
                                </div>
                    ...
                    {activeTab === 'faq' && (
                        <div className="content-tab">
                            <div className="faq-section">
                                <h3>5. Câu hỏi thường gặp về xét nghiệm ADN mẹ con</h3>
                                        ...
                                        <div className="faq-list">
                                            <div className="faq-item">
                                                <h5>
                                                    ...
                                                    Xét nghiệm ADN mẹ con có chính xác không?
                                                </h5>
                                                <p>
                                                    Xét nghiệm ADN mẹ con tại DNA CHAIN có độ chính xác <strong>99.99%</strong> 
                                            ...
                                            <div className="faq-item">
                                                <h5>
                                                    <span className="faq-icon">💰</span>
                                                    Chi phí xét nghiệm ADN mẹ con bao nhiều?
                                                </h5>
                                                <p>
                                    ...
                                    <div className="faq-category">
                                        ...
                                        <div className="faq-list">
                                            <div className="faq-item">
                                                ...
                                                <p>
                                                    <strong>Có</strong>, cuống rốn là một trong những mẫu tốt nhất cho xét nghiệm ADN mẹ con. 
...
export default MotherChildService;