...
public class TestResultService {
    ...
    private TestResultResponseDTO mapToResponseDTO(TestResult testResult) {
        ...
        // Nếu resultFile không null và không bắt đầu bằng /uploads/, tự động nối thêm
        String file = testResult.getResultFile();
        if (file != null && !file.isEmpty() && !file.startsWith("/uploads/")) {
            file = "/uploads/" + file;
        }
